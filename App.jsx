...
${marine ? `- Wave height: ${f1(marine.waveHeight)}m, period ${f0(marine.wavePeriod)}s (${marine.wavePeriod != null && marine.wavePeriod < 8 ? "short-period wind chop" : "longer-period groundswell"}) from ${marine.waveDirection}\n- Swell: ${f1(marine.swellHeight)}m at ${f0(marine.swellPeriod)}s from ${marine.swellDirection}` : '- No ocean swell (sheltered location)'}
